    ...
    namespace Devices
    {
        ...
        class BaseDevice : public virtual IDevice
        {
          public:
            ...
            void
            Initialise() override final;
            void
            Shutdown() override final;
            void
            Wait() override final;
            void
            Wait( std::chrono::milliseconds timeout_ms ) override final;
            std::string
          ...
          protected:
            ...
            StartAsyncAction();
            void
            FinaliseAsyncAction( DeviceResponse response );
            virtual DeviceResponse
            ToDeviceResponse( DriverResponse response ) const;
